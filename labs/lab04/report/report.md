...
![Открытие файла с помощью текстового редактора gedit](image/.jpg){#fig:004 width=70%}

Введём в него следующий текст (рис. [-@fig:005]).

![Ввод текста](image/.jpg){#fig:005 width=70%}

## Транслятор NASM

Скомпилируем приведённый выше текст программы «Hello World» (рис. [-@fig:006]).

![Компиляция текста](image/.jpg){#fig:006 width=70%}

С помощью команды ls проверим, что объектный файл был создан (рис. [-@fig:007]).

![Проверка создания объектного файла](image/.jpg){#fig:007 width=70%}
...
![Открытие файла с помощью текстового редактора gedit](image/.jpg){#fig:021 width=70%}

![Изменеие текста программы в файле lab4.asm](image/.jpg){#fig:022 width=70%}

Скомпилируем текст файла lab4.asm (рис. [-@fig:023]).

![Компиляция текста](image/.jpg){#fig:023 width=70%}
...
![Компиляция файла lab4.asm в obj.o](image/.jpg){#fig:024 width=70%}

Передадим объектный файл на обработку компоновщику (рис. [-@fig:025]).

![Передача объектного файла на обработку компоновщику](image/.jpg){#fig:025 width=70%}

Зададим имя создаваемого исполняемого файла (рис. [-@fig:026]).

![Дача имени файлу](image/.jpg){#fig:026 width=70%}

С помощью команды ls проверим, что нужные файлы были создан (рис. [-@fig:027]).

![Проверка создания файлов](image/.jpg){#fig:027 width=70%}

Запустим получившийся исполняемый файл (рис. [-@fig:028]).

![Запуск получившегося исполняемого файла](image/.jpg){#fig:028 width=70%}
...
![Копирование файла hello.asm](image/.jpg){#fig:029 width=70%}

![Копирование файла lab4.asm](image/.jpg){#fig:030 width=70%}

Загрузим файлы на Github (рис. [-@fig:031]).

![Загрузка файлов на Github](image/.jpg){#fig:031 width=70%}
